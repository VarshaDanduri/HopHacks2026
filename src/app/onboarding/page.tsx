...
function OnboardingContent() {
  ...
  const handleRoleToggle = (role: 'neighbor' | 'patron') => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!selectedRoles.neighbor && !selectedRoles.patron) {
    ...
    try {
      ...
      const rolesResponse = await fetch('/api/users/roles', {
        ...
        body: JSON.stringify({
          roles: {
            neighbor: selectedRoles.neighbor,
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                You can be both a Neighbor and a Patron, or choose just one role.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div 
                  className={`border-2 rounded-lg p-6 cursor-pointer transition-all ${
                    selectedRoles.neighbor 
                      ? 'border-indigo-500 bg-indigo-50' 
                      : 'border-gray-200 hover:border-gray-300'
                  }`}
                  onClick={() => handleRoleToggle('neighbor')}
                >
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">Neighbor</h3>
                  </div>
            ...
            <button
              type="submit"
              disabled={isSubmitting || (!selectedRoles.neighbor && !selectedRoles.patron)}
