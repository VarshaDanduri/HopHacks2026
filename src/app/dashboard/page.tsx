      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your wishes and track your impact as a {userRoles.neighbor && userRoles.patron ? 'Neighbor and Patron' : userRoles.neighbor ? 'Neighbor' : 'Patron'}
          </p>
        </div>
          ...
          {userRoles.neighbor && (
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-semibold text-gray-900">Neighbor</h2>
              </div>
