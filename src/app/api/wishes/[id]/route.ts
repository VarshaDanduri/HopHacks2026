...
export async function GET(
  ...
  try {
    ...
    if (wish.status !== 'ELIGIBLE') {
      ...
      const isOwner = wish.neighborId === user.id;
...
// PATCH /api/wishes/[id] - Update wish (Neighbor owner only)
...
// DELETE /api/wishes/[id] - Delete wish (Neighbor owner only)
